...
pub fn or_handler(instr: Instruction) -> Result<()> {
    ...
    match instr.code() {
        ...
        Code::Or_rm64_imm32 => op::safe_set64(cpu::get64_register(instr.memory_base())? as usize, instr.immediate(1) as u64),
        Code::Or_rm32_imm32 => op::safe_set32(cpu::get64_register(instr.memory_base())? as usize, instr.immediate(1) as u32),
        Code::Or_rm16_imm16 => op::safe_set16(cpu::get64_register(instr.memory_base())? as usize, instr.immediate(1) as u16),
        Code::Or_rm8_imm8   => op::safe_set8(cpu::get64_register(instr.memory_base())? as usize, instr.immediate(1) as u8),
